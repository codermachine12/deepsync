...
XI_API_KEY = "sk_b0e9067fbc341fb138c7574f50575d7e593d94c48d9356aa"  # Your API key for authentication
VOICE_ID = "cjVigY5qzO86Huf0OWal"  # ID of the voice model to use
AUDIO_FILE_PATH = r"C:\Users\rohan\Wav2Lip\translation\demotrans.mp3"  # Path to the input audio file
OUTPUT_PATH = r"C:\Users\rohan\Wav2Lip\translation\output.mp3"  # Path to save the output audio file
